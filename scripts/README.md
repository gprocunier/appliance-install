...
The appliance package list generated by script `10` covers OpenShift
Virtualization, ODF, NMState, cert-manager, Network Observability, Web
Terminal, and Quay. Do not paste pull-secret content or generated
`appliance-config.yaml` contents into tracked documentation.
