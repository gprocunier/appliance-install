...
APPLIANCE_FOUNDRY_HOSTNAME="${APPLIANCE_FOUNDRY_HOSTNAME:-${APPLIANCE_FOUNDRY_SHORT_HOSTNAME}.${APPLIANCE_CLUSTER_DOMAIN}}"
...
APPLIANCE_FOUNDRY_OS_VARIANT="${APPLIANCE_FOUNDRY_OS_VARIANT:-rhel10.2}"
APPLIANCE_FOUNDRY_IMAGE_DIR="${APPLIANCE_FOUNDRY_IMAGE_DIR:-/home/libvirt/images/appliance-install/foundry}"
...
if [[ -z "${APPLIANCE_FOUNDRY_SSH_PUBLIC_KEY_FILE:-}" && -z "${APPLIANCE_FOUNDRY_SSH_KEY:-}" ]]; then
    echo "Set APPLIANCE_FOUNDRY_SSH_PUBLIC_KEY_FILE or APPLIANCE_FOUNDRY_SSH_KEY in config/foundry.env." >&2
    exit 1
fi
...
#### These steps validate foundry settings before touching the host

# Keep values inside the limits expected by libvirt, cloud-init, and shell tools.
validate_fqdn "APPLIANCE_CLUSTER_DOMAIN" "${APPLIANCE_CLUSTER_DOMAIN}"
validate_simple_name "APPLIANCE_FOUNDRY_NAME" "${APPLIANCE_FOUNDRY_NAME}"
validate_dns_label "APPLIANCE_FOUNDRY_SHORT_HOSTNAME" "${APPLIANCE_FOUNDRY_SHORT_HOSTNAME}"
...
validate_positive_integer "APPLIANCE_FOUNDRY_MEMORY_MB" "${APPLIANCE_FOUNDRY_MEMORY_MB}"
validate_positive_integer "APPLIANCE_FOUNDRY_VCPUS" "${APPLIANCE_FOUNDRY_VCPUS}"
validate_positive_integer "APPLIANCE_FOUNDRY_DISK_SIZE_GB" "${APPLIANCE_FOUNDRY_DISK_SIZE_GB}"
validate_simple_name "APPLIANCE_FOUNDRY_OS_VARIANT" "${APPLIANCE_FOUNDRY_OS_VARIANT}"
validate_absolute_path "APPLIANCE_FOUNDRY_IMAGE_DIR" "${APPLIANCE_FOUNDRY_IMAGE_DIR}"
validate_absolute_path "APPLIANCE_FOUNDRY_BASE_IMAGE" "${APPLIANCE_FOUNDRY_BASE_IMAGE}"
validate_simple_name "APPLIANCE_FOUNDRY_UPSTREAM_NETWORK" "${APPLIANCE_FOUNDRY_UPSTREAM_NETWORK}"
...
validate_mac "APPLIANCE_FOUNDRY_UPSTREAM_MAC" "${APPLIANCE_FOUNDRY_UPSTREAM_MAC}"
validate_mac "APPLIANCE_FOUNDRY_APPLIANCE_MAC" "${APPLIANCE_FOUNDRY_APPLIANCE_MAC}"
validate_ipv4 "APPLIANCE_FOUNDRY_APPLIANCE_IP" "${APPLIANCE_FOUNDRY_APPLIANCE_IP}"
validate_ipv4_prefix "APPLIANCE_FOUNDRY_APPLIANCE_PREFIX" "${APPLIANCE_FOUNDRY_APPLIANCE_PREFIX}"
validate_boolean "APPLIANCE_FOUNDRY_WAIT_FOR_SSH" "${APPLIANCE_FOUNDRY_WAIT_FOR_SSH}"
validate_ssh_public_key "APPLIANCE_FOUNDRY_SSH_PUBLIC_KEY" "${APPLIANCE_FOUNDRY_SSH_PUBLIC_KEY}"
