...
Later VM work will still be launched from the operator workstation unless a
script explicitly says otherwise. Generated services inside the VMs will be
called out separately when they are added.
